...
repeat wait() bindablefunction = game:FindFirstChild("Plugin") until bindablefunction

local loadstring = vlua5_1()
bindablefunction.OnInvoke = function(str)
